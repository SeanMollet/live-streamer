...
HimppAencChan::HimppAencChan(HimppAudioElement *source, AudioEncodingType encoding, AENC_CHN chnid)
...
HimppAdecChan::HimppAdecChan(HimppAudioElement *source, AudioEncodingType encoding, ADEC_CHN chnid)
	: AudioElement(AUDIO_ELEMENT(source)), HimppAudioElement(source),
