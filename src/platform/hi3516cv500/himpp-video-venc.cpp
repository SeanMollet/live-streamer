...
void HimppVencChan::setBitrate(uint32_t value)
{
	if (is_enabled())
	{
		...
		{
		case CBR:
			attr.stRcAttr.stH264Cbr.u32BitRate = value;
			break;
		case VBR:
			attr.stRcAttr.stH264AVbr.u32MaxBitRate = value;
			break;
		default:
...
void HimppVencChan::setGovLength(uint32_t value)
{
	if (is_enabled())
	{
		...
		{
		case CBR:
			attr.stRcAttr.stH264Cbr.u32Gop = value;
			break;
		case VBR:
			attr.stRcAttr.stH264AVbr.u32Gop = value;
			break;
		case FIXQP:
			attr.stRcAttr.stH264FixQp.u32Gop = value;
			break;
		default:
